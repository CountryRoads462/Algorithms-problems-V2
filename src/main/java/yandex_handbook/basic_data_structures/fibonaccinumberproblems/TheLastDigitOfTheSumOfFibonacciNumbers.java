...
public class TheLastDigitOfTheSumOfFibonacciNumbers {

    private final static FastScanner FS = new FastScanner(System.in);
    ...
    public static void main(String[] args) throws IOException {
        ...
        int result = calculateLastDigit(remainder)[1];
